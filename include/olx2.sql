...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2022 at 01:52 PM
...
(5, 'Golu jha', 2147483647, 'golu@g.c', 'araria', '0000-00-00 00:00:00.000000', 'car.jpg', '123');
...
(74, 'phone', 'hhhf', 'sony', 'car.jpg', 5000000, '5', '2022-12-26 12:32:37', 'golu jha', 'araria', 1);
...
--
ALTER TABLE `products`
  MODIFY `p_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
COMMIT;
